...
class Ui_QeditForm(object):
    def setupUi(self, QeditForm):
        ...
        self.category_1 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_1.setObjectName("category_1")
        self.buttonGroup = QtWidgets.QButtonGroup(QeditForm)
        self.buttonGroup.setObjectName("buttonGroup")
        self.buttonGroup.addButton(self.category_1)
        self.horizontalLayout_4.addWidget(self.category_1)
        self.category_2 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_2.setObjectName("category_2")
        self.buttonGroup.addButton(self.category_2)
        self.horizontalLayout_4.addWidget(self.category_2)
        self.category_3 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_3.setObjectName("category_3")
        self.buttonGroup.addButton(self.category_3)
        self.horizontalLayout_4.addWidget(self.category_3)
        self.category_4 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_4.setObjectName("category_4")
        self.buttonGroup.addButton(self.category_4)
        self.horizontalLayout_4.addWidget(self.category_4)
        self.category_5 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_5.setObjectName("category_5")
        self.buttonGroup.addButton(self.category_5)
        self.horizontalLayout_4.addWidget(self.category_5)
        self.category_6 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_6.setObjectName("category_6")
        self.buttonGroup.addButton(self.category_6)
        self.horizontalLayout_4.addWidget(self.category_6)
        self.category_7 = QtWidgets.QRadioButton(self.groupBox_2)
        self.category_7.setObjectName("category_7")
        self.buttonGroup.addButton(self.category_7)
        self.horizontalLayout_4.addWidget(self.category_7)
    ...
    def retranslateUi(self, QeditForm):
        ...
        self.category_1.setText(_translate("QeditForm", "选择"))
        self.category_2.setText(_translate("QeditForm", "判断"))
        self.category_3.setText(_translate("QeditForm", "填空"))
        self.category_4.setText(_translate("QeditForm", "名词解释"))
        self.category_5.setText(_translate("QeditForm", "问答"))
        self.category_6.setText(_translate("QeditForm", "算法"))
        self.category_7.setText(_translate("QeditForm", "计算"))
