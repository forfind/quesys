...
def main():
    ...
    #for cate in ["'选择'","'填空'","'名词解释'","'问答'"]:
    #    for diff in ["'高'","'中'","'低'"]:
    #        for i in range(30):
    #            id = bop.add_exercise("'测试'","F:/project/quesys/src/img/16gl-Q.png","'测试'","F:/project/quesys/src/img/16gl-Y.png",cate,10,1,diff)
    #            print(id)
    id=bop.add_exercise("'测试'","F:/project/quesys/src/img/16gl-Q.png","'测试'","F:/project/quesys/src/img/16gl-Y.png","'选择'",10,1,"'高'")
    print(id)
    #bop.add_paper('4, 6, 9, 10',0.2,0.7,0.1)
    #bop.query_paper("all")
    #print(bop.query_exercise("exercise_base_info.ExerciseCode=1283"))
